...
# 交易所对端 IP → 交易所名称映射
# 来源：交易所专线路由（主备）.doc + 接收机.xlsx
# IP 可以是纯 IP（匹配任意端口）
EXCHANGE_IP_MAP = {
    # 大商所（DCE）
    '10.10.2.1':    '大商所',   '10.10.2.2':    '大商所',
    '10.90.2.1':    '大商所',   '10.90.2.2':    '大商所',
    '10.10.2.139':  '大商所',   '10.10.2.140':  '大商所',
    '10.10.2.141':  '大商所',   '10.10.2.142':  '大商所',
    '10.10.2.143':  '大商所',   '10.10.2.151':  '大商所',
    '10.10.2.152':  '大商所',
    '10.90.2.139':  '大商所',   '10.90.2.140':  '大商所',
    '10.90.2.141':  '大商所',   '10.90.2.142':  '大商所',
    '10.90.2.143':  '大商所',   '10.90.2.151':  '大商所',
    '10.90.2.152':  '大商所',
    # 郑商所（CZCE）
    '129.20.1.41':       '郑商所',  '129.20.1.42':  '郑商所',
    '129.20.1.43':       '郑商所',  '129.20.1.44':  '郑商所',
    '129.20.1.45':       '郑商所',  '129.20.1.46':  '郑商所',
    '129.20.1.47':       '郑商所',  '129.20.1.48':  '郑商所',
    '10.30.64.145':      '郑商所',  '10.30.64.146': '郑商所',
    '61.163.243.173':    '郑商所',  '123.161.206.213': '郑商所',
    # 中金所（CFFEX）
    '172.30.17.21':  '中金所',   '172.30.16.22':  '中金所',
    '172.30.17.23':  '中金所',   '172.30.16.24':  '中金所',
    '172.27.16.31':  '中金所',   '172.27.16.32':  '中金所',
    # 上期所（SHFE / 能源）
    '192.168.12.73': '上期所',   '192.168.11.73': '上期所',
    '192.168.48.71': '上期所',   '192.168.32.71': '上期所',
    '192.168.12.74': '上期所',   '192.168.11.74': '上期所',
    '192.168.80.72': '上期所',   '192.168.64.72': '上期所',
    # 上交所（SSE / 沪）
    '172.39.25.55':  '上交所',   '172.39.25.54':  '上交所',
    '172.39.25.124': '上交所',   '172.39.25.122': '上交所',
    '172.39.27.95':  '上交所',   '172.39.27.93':  '上交所',
    '172.39.27.85':  '上交所',   '172.39.27.84':  '上交所',
    # 上交所联通专线复用（深L1期权、北交所债券）
    '172.39.28.145': '上交所(复用)',  '172.39.28.146': '上交所(复用)',
    '172.39.28.141': '上交所(复用)', '172.39.28.142': '上交所(复用)',
    # 黄金交易所（SGE）
    '192.21.34.25':  '上海黄金交易所',
    '172.21.34.25':  '上海黄金交易所',
    # 广期所（GFEX）
    '21.5.18.129':   '广期所',   '21.5.18.130':   '广期所',
    '21.5.18.148':   '广期所',   '21.5.18.149':   '广期所',
    '21.37.18.148':  '广期所',   '21.37.18.149':  '广期所',
    '21.69.18.148':  '广期所',   '21.69.18.149':  '广期所',
    '21.5.18.177':   '广期所',   '21.5.18.178':   '广期所',
    # 深交所L2（SZSE L2）
    '172.27.1.31':   '深交所L2',  '172.27.129.31': '深交所L2',
    '172.27.1.32':   '深交所L2',  '172.27.129.32': '深交所L2',
    '172.27.1.199':  '深交所L2',  '172.27.129.199':'深交所L2',
    # 深交所L1（SZSE L1）
    '172.27.0.45':   '深交所L1',  '172.27.128.45': '深交所L1',
    '172.27.0.38':   '深交所L1',  '172.27.128.36': '深交所L1',
    '172.27.0.198':  '深交所L1',  '172.27.128.198':'深交所L1',
    # 深交所新三板（NEEQ）
    '172.50.101.60': '新三板',   '172.60.101.60': '新三板',
    # 北交所债券（BSE Bond）
    '172.60.101.206':'北交所债券','172.60.101.207':'北交所债券',
    '172.50.101.206':'北交所债券','172.50.101.207':'北交所债券',
    '172.50.101.120':'北交所债券','172.60.101.120':'北交所债券',
    # 港交所（HKEX）- 经济通恒指
    '10.80.21.60':   '港交所(恒指)',
    # 港交所 - 跨境直连
    '10.1.90.82':  '港交所(直连)', '10.1.90.83':  '港交所(直连)',
    '10.2.90.82':  '港交所(直连)', '10.2.90.83':  '港交所(直连)',
    '10.1.90.61':  '港交所(直连)', '10.1.90.62':  '港交所(直连)',
    '10.2.90.61':  '港交所(直连)', '10.2.90.62':  '港交所(直连)',
    # 上证云（通过跳板机 VPN 接入，Windows 接收机，无法追溯上游交易所）
    '10.20.205.181': '上证云',
}
